...
import tw.edu.sju.ee.eea.module.signal.oscillogram.*;
 ...
 */
@NavigatorPanel.Registration(displayName = "Device", mimeType = "application/device")
@Messages({
...
public final class DeviceNavigatorPanel extends JPanel implements NavigatorPanel, ExplorerManager.Provider, LookupListener {
    ...
    public void panelActivated(Lookup lkp) {
        Logger.getLogger(DeviceNavigatorPanel.class.getName()).log(Level.INFO, "pa");
    ...
    public void panelDeactivated() {
        Logger.getLogger(DeviceNavigatorPanel.class.getName()).log(Level.INFO, "pd");
    ...
    public void resultChanged(LookupEvent le) {
        Logger.getLogger(DeviceNavigatorPanel.class.getName()).log(Level.INFO, manager.getRootContext().getDisplayName());
